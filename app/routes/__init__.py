...
from app.routes import votacion_routes
from app.routes import sancion_routes
from app.routes import rol_routes
from app.routes import estado_routes
from app.routes import tipoDocumento_routes